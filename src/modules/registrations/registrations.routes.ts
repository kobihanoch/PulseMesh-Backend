...
import {
  ...
  listRegistrations,
  updateRegistration,
} from './registrations.controller.ts';
import {
...
router.get('/', validate(listRegistrationsRequest), asyncHandler(withRlsTx(listRegistrations), registrationsListResponse) as unknown as RequestHandler);
